<?php
  class Migration_categoriesController extends CrudController{
    public $add_models = array("users","migration_categories");


    public function test_db(){
        $test_res = Migration_categories::test_db_connection();
        return "ok now 2";
    }
