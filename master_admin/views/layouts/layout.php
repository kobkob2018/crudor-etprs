...
<html>
  <head>
		...
		<script src="<?= styles_url('style/js/admin-master.js') ?>?v=<?= get_config("cash_version") ?>"></script>
		<link rel="stylesheet" href="<?= global_url("global_style/css/admin_global.css") ?>?v=<?= get_config("cash_version") ?>"  type="text/css" />
		<link rel="stylesheet" href="<?= styles_url('style/css/master_admin_local.css') ?>?v=<?= get_config("cash_version") ?>"  type="text/css" />	
