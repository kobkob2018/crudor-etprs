<?php
  class Whatsapp_settings extends TableModel{

    protected static $settings = false;
    protected static $main_table = 'whatsapp_settings';
    ...
    public static function update_kv_params($update_values){
      ...
      foreach($settings_arr as $set){
        if(isset($update_values[$set['param_name']])){
          ...
          $sql = "UPDATE whatsapp_settings SET $val_type = :val WHERE param_name = :param_name";	
          $req = $db->prepare($sql);
