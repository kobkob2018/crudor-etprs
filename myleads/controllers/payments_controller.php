<?php
  ...
  class PaymentsController extends CrudController{
    ...
    public function list(){
        ...
        $payload = array('order_by'=>'pay_date desc');
        $old_user_payments = Myleads_old_user_payments::get_list($filter_arr,"*, DATE_FORMAT(pay_date,'%d-%m-%Y') as pay_date_heb",$payload);
