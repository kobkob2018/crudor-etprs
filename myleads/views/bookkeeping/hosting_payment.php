                            ...
                            <div class='buy_hosting_desc form-group'>
                                ...
                                <?php else: ?>
                                    <div class='buy_leads_token_select form-group '>
                                        ...
                                        <select onchange="toggle_token_fields(this)" data-token_fields="token-fields-hosting" name='use_token' id='use_token_select' class="form-select use-token input_style">
                                ...
                                <?php endif; ?>
                                    <div class="token-fields-hosting hidden">
                                        ...
                                        <div class="payments-select-wrap form-group hidden" >
                                            בחר מספר תשלומים: <br/>
