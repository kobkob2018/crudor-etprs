<?php
  class Migration_rightMenuController extends CrudController{
    public $add_models = array("sites","migration_site", "migration_rightMenu");
    ...
    public function prepare(){
      ...
      $info = array(
        'migration_exist'=>Migration_rightMenu::check_if_migration_exist($filter_arr)
      );
      return $this->include_view("migration_rightMenu/prepare.php",$info);
    }
    ...
    public function do_migrate(){
        $filter_arr = $this->get_base_filter();
        $migration_site = Migration_site::find($filter_arr);      
        Migration_rightMenu::do_migrate($this->data['work_on_site']['id'],$migration_site);
        ...
        return $this->redirect_to(inner_url("migration_rightMenu/prepare/"));
    }


    public function delete_older(){   
        Migration_rightMenu::delete_older($this->data['work_on_site']['id']);
